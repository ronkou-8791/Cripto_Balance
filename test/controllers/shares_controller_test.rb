...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { btcjpy: @share.btcjpy, coin: @share.coin, create_at: @share.create_at } }
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { btcjpy: @share.btcjpy, coin: @share.coin, create_at: @share.create_at } }
